...
public class Constants {
    ...
    public static final String UNSUCCESSFULLY_ADDED_USER = "Cannot add user!";
    public static final String SUCCESSFULLY_REMOVED_USER = "Successfully removed user!";
    public static final String UNSUCCESSFULLY_REMOVED_USER = "Cannot remove user!";

    //skill message responses
    public static final String SUCCESSFULLY_ADDED_SKILL = "Successfully added skill!";
    public static final String UNSUCCESSFULLY_ADDED_SKILL = "Cannot add skill!";
    public static final String SUCCESSFULLY_REMOVED_SKILL = "Successfully removed skill!";
    public static final String UNSUCCESSFULLY_REMOVED_SKILL = "Cannot remove skill!";

    //user-skill message responses
    ...
    public final static int SYNC_WITH_DB_TIMER = 1_000 * 10;
}
